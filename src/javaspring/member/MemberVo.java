...
public class MemberVo {
  ...
  public String toString() {
    return "MemberVo [idx=" + idx + ", mid=" + mid + ", pwd=" + pwd + ", nickname=" + nickname + ", name=" + name
        ...
        + ", homepage=" + homepage + ", job=" + job + ", hobby=" + hobby + ", userinfor=" + userinfor + ", userdel="
        + userdel + ", level=" + level + ", visitCnt=" + visitCnt + ", startDate=" + startDate + ", lastDate="
        + lastDate + ", money=" + money + "]";
  }
