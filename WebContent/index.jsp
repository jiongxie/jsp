                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <img class="img-responsive" src="./assets/images/new1.PNG" alt="First slide" style="width:100%; height:600px;">
                            </div>
                            <div class="item">
                                <img class="img-responsive" src="./assets/images/new2.PNG" alt="Second slide" style="width:100%; height:600px;">
                            </div>
                            <div class="item">
                                <img class="img-responsive" src="./assets/images/new3.PNG" alt="Second slide" style="width:100%; height:600px;">
                            </div>
                        </div>
	    ...
	    <div class="container">
	        <div class="row">
	            <div class="col-xs-12 col-md-12 section-container-spacer">
	                <h2 class="text-center">투자 사이트</h2>
	            </div>
	        </div>
	        <div class="row">
	            ...
	            <div class="col-xs-12 col-md-4">
	                ...
	                <p>시장수익률이상의 알파를 추구하는 투자자들을 위한 커뮤니티 공간, 바로가기.</p>
	            </div>
	            <div class="col-xs-12 col-md-4">
