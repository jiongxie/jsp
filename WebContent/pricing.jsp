        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="pricing-card pricing-primary">
                    <h3>안전추구형</h3>
                    <h6 class="price">5 <span>%/Y(기대수익률)</span></h6>
                </div>
            ...
            <div class="col-md-4">
            		<form name="myform" method="post" action="${contextPath }/pricing2.mem">
                <div class="pricing-card pricing-info">
                    <h3>위험중립형(기본형)</h3>
                    <h6 class="price"> 7.5 <span>%/Y(기대수익률)</span></h6>
                </div>
                <div class="pricing-features">
                    <ul class="features">
                    ...
                    <c:if test="${slevel > 0 && slevel < 4}">
                   		<input type="button" class="btn btn-primary" title="" onclick="submit()" value="바로가기"/>
                   	</c:if>
            ...
            <div class="col-md-4">
                ...
                <div class="pricing-card pricing-secondary">
                    <h3>적극투자형</h3>
                    <h6 class="price">10 <span>%/Y(기대수익률)</span></h6>
                </div>
                <div class="pricing-features">
                    <ul class="features">
