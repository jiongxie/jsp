    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <br/>
									<div class="container">
										<form name="myform" method="post" action="${contextPath}/bInputOk.nt">
										  <table class="table">
										  </table>
										    ...
										    <tr>
											  ...
											  <tr>
											    <td colspan=2 style="text-align:center;">
											      ...
											      <input type="button" value="돌아가기" onclick="location.href='${contextPath}/bList.nt?pag=${param.pag}&pageSize=${param.pageSize}';" class="btn btn-secondary"/>
											    </td>
											  </tr>
										  </table>
