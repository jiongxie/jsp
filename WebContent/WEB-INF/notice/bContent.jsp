...
<link href="./main.a3f694c0.css" rel="stylesheet">
  ...
  function delCheck() {
  	...
  	if(ans) {
  		location.href="${contextPath}/bDelete.nt?idx=${vo.idx}&pwd="+pwd+"&pag=${pag}";
  	}
  }
  function adelCheck() {
  	var ans = confirm("현 게시물을 삭제하시겠습니까?");
  	if(ans) {
  		location.href="${contextPath}/abDelete.nt?idx=${vo.idx}&pag=${pag}";
  	}
  }
    function updCheck() {
    	var pwd = myform.pwd.value;
    	location.href="${contextPath}/bUpdate.nt?idx=${vo.idx}&pwd="+pwd+"&pag=${pag}";
    }
            ...
            <div class="col-xs-12">
                <div class="container">
									<form name="myform" method="post">
									  <br/>
									  <table class="table table-bordered" style="border: 5px solid #aaa;">
									    <tr style="border: 5px solid #aaa;">
									      <th>글쓴이</th>
									      <td>${vo.name}</td>
									      <th>글쓴날짜</th>
									      <td>${vo.wdate}</td>
									    ...
									    <tr style="border: 5px solid #aaa;"s>
									      <th>글제목</th>
									    ...
									    <tr>
									      <td colspan=4 style="text-align:center;">
									        <input type="button" value="수정" onclick="updCheck()"/>
										        ...
										        <input type="button" value="돌아가기" onclick="location.href='${contextPath}/bList.nt?pag=${pag}&pageSize=${pageSize}';"/>
									...
									<!-- 댓글 입력처리 -->
									<form name="contForm" method="post" action="${contextPath}/bContInput.nt">
									  <table class="table">
									    <tr>
									      ...
									      <td style="line-height:20px;">
									        ...
									        <p style="color:blue;"><input type="button" value="돌아가기" onclick="location.href='${contextPath}/bList.nt?pag=${pag}&pageSize=${pageSize}';"/></p>
									      </td>
									    </tr>
									  </table>
