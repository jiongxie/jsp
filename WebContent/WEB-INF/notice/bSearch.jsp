								        ...
								        <table style="width:100%;">
								          <tr>
								            <td style="text-align:left;border:none;width:8%;">
								              <button type="button" onclick="location.href='${contextPath}/bInput.nt?pag=${pag}&pageSize=${pageSize}';" class="btn btn-secondary btn-sm">글올리기 </button>
								            </td>
								            <td style="text-align:left;border:none;width:8%;">
								              <button type="button" onclick="location.href='${contextPath}/bList.nt?pag=${pag}&pageSize=${pageSize}';" class="btn btn-secondary btn-sm">돌아가기 </button>
								            </td>
								    ...
								    <c:forEach var="vo" items="${vos}">  <!-- for(String str : 배열명) -->
									    <tr>
									      ...
									      <td style="text-align:left;">
									        <a href="${contextPath}/bContent.nt?idx=${vo.idx}&pag=${pag}" style="color:#666">${vo.title}</a>
