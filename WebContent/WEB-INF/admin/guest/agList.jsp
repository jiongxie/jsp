                ...
                <div class="container">
								...
								<!-- 페이징 처리 시작   -->
								  <div style="text-align:center;">
								    <% if(pag != 1) { %>
								       [<a href="agList.ad?pag=1" style="color:black;">첫페이지</a>]
								    <% } %>
								    <% if(pag > 1) { %>
								       [<a href="agList.ad?pag=<%=pag-1%>" style="color:black;">이전페이지</a>]
								    <% } %>
								    <%=pag%>Page / <%=totPage%>Pages 
								    <% if(pag < totPage) { %>
								       [<a href="agList.ad?pag=<%=pag+1%>" style="color:black;">다음페이지</a>]
								    <% } %>
								    <% if(pag != totPage) { %>
								       [<a href="agList.ad?pag=<%=totPage%>" style="color:black;">끝페이지</a>]
								    <% } %>
								  </div>
								<!-- 페이징 처리 끝   -->
								<p><br/></p>
