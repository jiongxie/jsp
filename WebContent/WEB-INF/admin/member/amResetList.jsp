            ...
            <div class="col-xs-12">
								...
								%>
								      <tr>
								        ...
								        <td>
								          <form name="myform" method="get" action="<%=request.getContextPath()%>/levelCheck.ad&pag='+pag+'">
								        ...
								        <td>
								          <a href="javascript:memberResetCheck('<%=vo.getMid()%>')"><%=userDel %></a><br/>
								          (<%=vo.getLastDate().substring(0, 10) %>)
								        </td>
								      </tr>
								<%
								      cnt--;
