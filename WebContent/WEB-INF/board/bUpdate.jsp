...
<div class="background-image-container white-text-container" style="background-image: url('./assets/images/img-13.jpg')">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
									<div class="container">
										<form name="myform" method="post" action="${contextPath}/bUpdateOk.bo">
										  <table class="table">
										  </table>
										    ...
										    <tr>
											  ...
											  <tr>
											    <td colspan=2 style="text-align:center;">
											      ...
											      <input type="button" value="돌아가기" onclick="location.href='${contextPath}/bList.bo?pag=${pag}';" class="btn btn-secondary"/>
											    </td>
											  </tr>
										  </table>
