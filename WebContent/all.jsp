...
<div class="background-image-container white-text-container" style="background-image: url('./assets/images/img-18.jpg')" id="contact-section-container0">
	            ...
	            <div class="col-xs-12 col-md-12 section-container-spacer">
	                <h2 class="text-center">고객지원</h2>
					        <ul class="nav navbar-nav navbar-right">
					            <li><a href="./index.jsp#contact-section-container0" title="" class="anchor-link">Home</a></li>
					        </ul>
	            </div>
	        </div>
	        <div class="row">
...
<div class="section-container" id="contact-section-container3">
	<div class="section-container">
	    <div class="container">
	        ...
	        <div class="row">
	            <div class="col-xs-12 col-md-4">
	                <a href="./item/all.jsp"><img src="./assets/images/img-02.jpg" alt="" class="img-responsive"></a>
	                <h3 class="text-center">All weather Fund</h3>
	                <p>시장수익률만을 추구 , 자산배분의 마법,검증된 All weather investment에 투자하세요</p>
	            </div>
	
	            <div class="col-xs-12 col-md-4">
	                <a href="./item/beta.jsp"><img src="./assets/images/img-03.jpg" alt="" class="img-responsive"></a>
	                <h3 class="text-center">Pure alpha Fund </h3>
	                <p>관심종목 분석해드립니다.재무재표,관련레포트,논문,통계,백테스트 등 자료제공</p>
	            </div>
	            <div class="col-xs-12 col-md-4">
	                <a href="./item/ai.jsp"><img src="./assets/images/img-04.jpg" alt="" class="img-responsive"></a>
            ...
            <div class="col-xs-12 col-md-offset-2 col-md-8">
                ...
                <form action="">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" name="이름" class="form-control" placeholder="Name">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="email" name="이메일" class="form-control" placeholder="Email">
                            </div>
                        </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary">보내기</button>
                     <button type="submit" class="btn btn-primary"><a href="${pageContext.request.contextPath}/chatting/chat.jsp" style="color:white;">실시간 상당채팅</a></button>
